...
export const Recommendations: React.FC<Recoprop> = ({ formdata }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <h1 className="text-2xl font-bold text-blue-700 mb-6 border-b-2 border-blue-700 pb-2">
      ...
      {array.map((elem, index) => (
        <div key={index} className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div>
              <h3 className="flex items-center text-base sm:text-lg font-semibold text-blue-700 mb-2">
